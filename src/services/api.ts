...
const mockFaculties: Faculty[] = [
  ...
  { id: "3", name: { english: "Arts & Humanities", khmer: "សិល្បៈ និងមនុស្សសាស្ត្រ" }, description: { english: "Programs in English for Communication, Translation, and Khmer Literature.", khmer: "កម្មវិធីភាសាអង់គ្លេសសម្រាប់ការទំនាក់ទំនង ការបកប្រែ និងអក្សរសាស្ត្រខ្មែរ។" }, iconName: "BookOpen" },
