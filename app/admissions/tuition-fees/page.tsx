      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <div className="lg:w-3/4">
            <h2 className="text-3xl font-serif font-bold text-gray-900 mb-6 font-khmer">ការបង់ថ្លៃសិក្សា</h2>
            <div className="w-16 h-1 bg-secondary mb-10"></div>

            <p className="text-lg text-gray-700 mb-8 leading-relaxed">
              Below is our comprehensive fee structure across all campuses. All figures are represented in USD.
            </p>
                ...
                <table className="w-full text-left border-collapse">
                  <thead>
                    <tr className="bg-primary text-white">
                      ...
                      <th className="p-5 font-serif font-bold border-b border-primary-light text-right whitespace-nowrap font-khmer">បរិញ្ញាបត្ររង</th>
                      <th className="p-5 font-serif font-bold border-b border-primary-light text-right whitespace-nowrap font-khmer">បរិញ្ញាបត្រ</th>
                      <th className="p-5 font-serif font-bold border-b border-primary-light text-right whitespace-nowrap font-khmer">បរិញ្ញាបត្រជាន់ខ្ពស់</th>
                    </tr>
                  </thead>
                  <tbody>
            ...
            <div className="bg-gray-50 p-8 rounded-sm border border-gray-200">
              <div className="flex items-start mb-6">
                ...
                <h3 className="text-2xl font-bold text-gray-900 font-khmer">{info.scholarship_conditions.title}</h3>
              </div>
              <div className="space-y-6">
                {info.scholarship_conditions.categories.map((cat, idx) => (
                  <div key={idx} className="bg-white p-6 border border-gray-100 rounded-sm">
                    <h4 className="font-bold text-primary mb-2 font-khmer">{cat.level}</h4>
                    <p className="text-gray-700 font-khmer leading-relaxed">{cat.condition}</p>
                  </div>
                ))}
                <p className="text-sm text-gray-500 italic font-khmer mt-4">
                  * {info.scholarship_conditions.note}
                </p>
              </div>
            </div>
          </div>
