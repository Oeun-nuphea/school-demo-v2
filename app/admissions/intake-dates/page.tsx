      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <div className="lg:w-3/4">
            <h2 className="text-3xl font-serif font-bold text-gray-900 mb-6 font-khmer">វគ្គចូលរៀនបន្ទាប់</h2>
            <div className="w-16 h-1 bg-secondary mb-10"></div>

            <p className="text-lg text-gray-700 mb-12 leading-relaxed">
              We offer multiple intakes throughout the year. Ensure you submit your application well before the deadlines associated with these dates.
            </p>
                ...
                return (
                  <div key={idx} className="bg-white border border-gray-100 p-8 rounded-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300 relative overflow-hidden group">
                    ...
                    <div className="relative z-10">
                      ...
                      <p className="text-gray-700 text-lg mb-6 font-khmer">{intakeObj.date}</p>
            ...
            <div className="bg-gray-50 border border-gray-200 p-8 rounded-sm">
              <h3 className="text-2xl font-serif font-bold text-gray-900 mb-4 font-khmer">{info.admission_requirements.title}</h3>
              <p className="text-gray-700 font-khmer leading-relaxed">
                {info.admission_requirements.description}
              </p>
            </div>
          </div>
