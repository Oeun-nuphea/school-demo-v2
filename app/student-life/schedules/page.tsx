      ...
      <div className="relative w-full h-[40vh] min-h-[300px] flex items-center justify-center">
        ...
        <div className="relative z-20 text-center px-4 mt-10">
          ...
          <p className="text-xl text-gray-200 font-sans max-w-2xl mx-auto">
            Flexible learning timetables designed to fit your busy life.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <div className="lg:w-3/4">
            <h2 className="text-3xl font-serif font-bold text-gray-900 mb-6">Flexible Learning Options</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              ...
              <div>
                <h3 className="text-2xl font-serif font-bold text-primary mb-6 flex items-center">
                  <Clock className="w-6 h-6 mr-3" /> Weekday Shifts
                </h3>
                <div className="space-y-4">
                  {info.study_schedule.monday_to_friday.map((schedule, idx) => (
                    <div key={idx} className="bg-white border border-gray-200 p-6 rounded-sm shadow-sm hover:border-primary/50 transition-colors">
                      <span className="block text-sm font-bold text-gray-500 uppercase tracking-widest mb-1">{schedule.shift}</span>
                      <span className="block text-xl font-medium text-gray-900">{schedule.time}</span>
                    </div>
                  ))}
                </div>
              </div>
              ...
              {/* Weekend */}
              <div>
                <h3 className="text-2xl font-serif font-bold text-secondary mb-6 flex items-center">
                  <Clock className="w-6 h-6 mr-3" /> Weekend Shifts
                </h3>
                <div className="space-y-4">
