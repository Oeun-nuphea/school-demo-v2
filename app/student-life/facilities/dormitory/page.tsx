          ...
          <aside className="lg:w-1/4">
            <div className="sticky top-28 bg-gray-50 p-6 rounded-sm border border-gray-100">
              ...
              <ul className="space-y-3">
                ...
                <li><Link href="/student-life/facilities/dormitory" className="block text-primary font-bold border-l-2 border-primary pl-3 transition-colors">{kh ? 'អន្តេវាសិកដ្ឋាន' : 'Dormitory'}</Link></li>
