    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="relative w-full min-h-[260px] flex items-center justify-center bg-gradient-to-r from-primary-dark to-primary overflow-hidden">
        ...
        <div className="relative z-20 text-center px-4 py-16">
          ...
          <p className="text-lg text-white/75 font-sans max-w-2xl mx-auto">
            {kh
              ? 'កម្មវិធីសិក្សាថ្នាក់បរិញ្ញាបត្ររង (Associate Degree) រយៈពេល ២ឆ្នាំ។'
              : 'Fast-track your career with our 2-year Associate Degree programs.'}
          </p>
        </div>
      </div>
      ...
      <div className="bg-gray-100 border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center text-sm text-gray-500">
          ...
          <ChevronRight className="w-4 h-4 mx-2 opacity-50" />
          <span className="text-gray-900 font-medium">{kh ? 'ថ្នាក់បរិញ្ញាបត្ររង' : 'Associate Programs'}</span>
        </div>
      </div>
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <aside className="lg:w-1/4">
            <div className="sticky top-28 bg-gray-50 p-6 rounded-sm border border-gray-100">
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <Link href="/programs/associate" className="block text-primary font-bold border-l-2 border-primary pl-3 transition-colors">{kh ? 'ថ្នាក់បរិញ្ញាបត្ររង' : 'Associate Programs'}</Link>
                </li>
                <li>
          ...
          <div className="lg:w-3/4">
            <h2 className="text-3xl font-serif font-bold text-gray-900 mb-6 font-khmer">
              {kh ? 'កម្មវិធីសិក្សាថ្នាក់បរិញ្ញាបត្ររង' : 'Associate Degrees'}
            </h2>
            ...
            <div className="bg-primary/5 border border-primary/20 rounded-sm p-8 text-center">
              ...
              <p className="text-gray-600 mb-6 max-w-lg mx-auto">
                {kh 
                  ? 'ព័ត៌មានលម្អិតនៃកម្មវិធីសិក្សាថ្នាក់បរិញ្ញាបត្ររងនឹងត្រូវបានអាប់ដេតឆាប់ៗនេះ។' 
                  : 'Detailed lists and module information for our Associate Programs are currently being compiled and will be available here soon.'}
              </p>
            </div>
          </div>
